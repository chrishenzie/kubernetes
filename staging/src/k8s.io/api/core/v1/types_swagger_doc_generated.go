...
var map_CgroupOptions = map[string]string{
	...
	"mountMode": "mountMode controls how the cgroup filesystem is mounted in the container. Valid values are \"ReadOnly\" and \"Writable\". If not specified, \"ReadOnly\" is used.",
}
