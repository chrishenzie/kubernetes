...
var map_CgroupOptions = map[string]string{
	...
	"mountMode": "mountMode controls how the cgroup filesystem is mounted in the container. Valid values are \"ReadOnly\" and \"Writable\". If not specified, the container runtime's default mount mode is used.",
}
